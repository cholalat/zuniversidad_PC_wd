...
for i in lista_semillas:
    parametros_alternativos_2["semilla"] = i
    simulacion_i_resultados, poblacion_viva_i = simular_cmtc(parametros_alternativos_2)
...
print(parametros_alternativos_2["gamma"])
