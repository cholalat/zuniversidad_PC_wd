...
parametros_alternativos_3["t_simulacion"] = 365*10
lista_semillas = [i for i in range(numero_simulaciones)]
...
for i in lista_semillas:
    parametros_alternativos_3["semilla"] = i
    simulacion_i_resultados, poblacion_viva_i = simular_cmtc(parametros_alternativos_3)
...
print(parametros_alternativos_3["phi"])
